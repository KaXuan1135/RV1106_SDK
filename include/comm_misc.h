...
typedef void (*af_process_cb_func_t)(int serial_no,int channel,int af,float gain);
...
int comm_get_cpu_tempture();
void comm_startSmartIr(int stream_index);
void comm_register_af_callback(af_process_cb_func_t cb);
