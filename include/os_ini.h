...
EXPORT_API int os_comm_isReadable(int fd,int msec);
EXPORT_API int os_comm_isWriteable(int fd,int msec);
EXPORT_API ssize_t os_comm_readn(int fd, void *vptr, size_t n);
EXPORT_API ssize_t os_comm_writen(int fd, const void *vptr, size_t n);
EXPORT_API ssize_t os_comm_readn_timeout(int fd, void *vptr, size_t n,int msec);
EXPORT_API ssize_t os_comm_writen_timeout(int fd, const void *vptr, size_t n,int msec);
