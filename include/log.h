...
#define PRINT_ATTR_DEF  printf("\033[0m\n");  //重新设置属性到缺省设置 
...
{		\
	...
	snprintf(dir_name, sizeof(dir_name) - 1,  "%s[%lu.%lu]", __FILE__, cur/1000, cur % 1000); \
	dump_print(stdout,dir_name,__LINE__,__FUNCTION__, ##args);   \
}		\
	}while(0)	
