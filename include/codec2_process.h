...
int app_request_IDR(int stream_index, bool instant);
...
int app_set_camera_angle(int stream_index, ROTATE_ANGLE angle);
...
int app_set_stream_sw_osd_polygon	(int stream_index, avcodec_osd_polygon_t *ocfg);
int app_set_stream_sw_osd_bitmap	(int stream_index, avcodec_osd_bitmap_t *ocfg);

int app_set_stream_sw_osd_str	(int stream_index, avcodec_osd_str_t *ocfg);
...
int app_ircut_setLastLevel(int stream_index,int nLevel);
int app_ircut_getLastLevel(int stream_index,int *nLevel);
int app_ircut_incTimerCount(int stream_index);
int app_ircut_getTimerCount(int stream_index,int *nTimerCount);
int app_ircut_resetTimerCount(int stream_index);
int app_ircut_set_ir_led(int stream_index,int strength);
int app_ircut_set_white_led(int stream_index,int strength);
/******************* 以下操作 属于图形转换 之类 ， 晚点再弄 ***************/
