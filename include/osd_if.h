...
public:
	...
	*
	*/
	void *GetOsdPolygonInfo(int point_num, short * coord, int thick);
	void SetPolygon(void * polygon_info, void* nv12_buff, unsigned int color=0x00ff0000);
	void ReleaseOsdPolygonInfo(void * polygon_info);
